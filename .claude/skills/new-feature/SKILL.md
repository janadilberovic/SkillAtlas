...
SkillAtlas maps company knowledge as a graph (people ↔ skills ↔ projects ↔ teams) on Neo4j. Read [CLAUDE.md](../../../CLAUDE.md) and the spec PDF (`SkillAtlas_Dokumentacija_za_praktikante.pdf`) before starting — the spec is the source of truth for fields, rules, and the API catalog.
